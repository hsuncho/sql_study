...
CREATE SEQUENCE dept2_seq
    START WITH 1 -- 시작값 (기본값은 증가할 때 최솟값, 감소할 때 최댓값)
...
CREATE TABLE dept2(
    dept_no NUMBER(2) PRIMARY KEY, --UNIQUE와 NOT NULL이 동시에 걸려 있음
...
ALTER SEQUENCE dept2_seq INCREMENT BY -81;
